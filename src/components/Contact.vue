<template>
    <section class="text-white mt-20" id="contact">
        ...
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                <p class="text-[#adb7be]">There is my contact you can contact me and i am willing to communicate with my pleasure
                </p>
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    ...
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>LinkedIn</h4>
                            <a href="https://www.linkedin.com/in/yohannes-getaneh/">https://www.linkedin.com/in/yohannes-getaneh/</a>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
  ...
  validateForm() {
    ...
    async submitForm() {
      ...
      try {
        await emailjs.send(
          'service_e8ywu9n', // Replace with your EmailJS service ID
          'template_nwo4bzq', // Replace with your EmailJS template ID
          {
            from_email: this.form.email,
            subject: this.form.subject,
            message: this.form.message
          },
          'Eq7JjKkFluW-ua5uj' // Replace with your EmailJS user ID
        );
